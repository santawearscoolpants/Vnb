...
const en = {
  ...
  'newsletter.success': 'Thank you for subscribing! You will receive updates from Vines & Branches.',
  ...
  'faq.a1': 'Sign in to your account and view order status under My Account. If order emails are enabled, you will also receive shipping/status updates by email.',
...
const fr: Record<keyof typeof en, string> = {
  ...
  'newsletter.success': 'Merci de votre abonnement ! Vous recevrez les actualités de Vines & Branches.',
  ...
  'faq.a1': "Connectez-vous à votre compte et consultez le statut de votre commande sous Mon Compte. Si les e-mails de commande sont activés, vous recevrez aussi les mises à jour par e-mail.",
